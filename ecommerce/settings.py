...
CASHFREE_ENABLED = config('CASHFREE_ENABLED', default=True, cast=bool)
"""
Django settings for ecommerce project.
...
# Site URL for payment gateway redirects
...
SHIPROCKET_API_EMAIL = config('SHIPROCKET_API_EMAIL', default='mylearning2609@gmail.com')
SHIPROCKET_API_PASSWORD = config('SHIPROCKET_API_PASSWORD',default='mwKvV$w8s4Y0SXFH')
SHIPROCKET_API_URL = config('SHIPROCKET_API_URL', default='https://apiv2.shiprocket.in/v1/external')
SHIPROCKET_ENABLED = config('SHIPROCKET_ENABLED', default=True, cast=bool)
SHIPROCKET_TOKEN = None
SHIPROCKET_PICKUP_PINCODE = config('SHIPROCKET_PICKUP_PINCODE',default='226022')
